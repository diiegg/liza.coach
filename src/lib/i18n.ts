...
export const translations = {
  ...
  ru: {
    ...
    about: {
      ...
      cta2: 'Образование и сертификаты',
      stat: 'Обучение и сертификация по стандартам ICF • Инструменты НЛП, метафорические карты, позитивная психология • Соблюдаю этику кодекса Международной Федерации Коучинга',
